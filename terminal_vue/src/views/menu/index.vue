            ...
            <el-aside style="background-color: white">
              <el-card>
                <div slot="header" class="clearfix">
                  <span>菜单管理</span>
                  <el-button style="float: right;" type="text" @click="addRoot">添加根菜单</el-button>
                </div>
                <el-tree
                :data="data"
                ...
                <div class="bottom">
                    <el-button type="text" style="margin-left:40px" class="button" @click="getDataInfo">刷新</el-button>
...
<script>
import { getMenuLabel,setMenuLabel,delMenuLabel } from '@/api/menu'
    ...
    methods:{
        ...
        setData(){
          new Promise((resolve, reject) => {
            ...
            //修改
            setMenuLabel(this.data).then(r =>{
              resolve()
            }).catch(()=>{reject()})
            //删除
            if(this.deldata.length>0){
              delMenuLabel(this.deldata).then(r=>{
                console.log(this.deldata)
                resolve();
              }).catch(()=>{reject()})
            }
