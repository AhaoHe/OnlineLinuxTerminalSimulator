            ...
            if (!check){
                ...
                if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                    ...
                    try {
                        ...
                        boolean validata = jwtTokenUtil.validateToken(token, userDetails);
                        boolean validataToken = userService.checkToken(username,request.getRemoteAddr(),token);
                    if (validata&&validataToken) {
